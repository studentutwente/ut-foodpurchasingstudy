...
<head>
  ...
  <title>Food Purchasing Study</title>
  <style>
    body {
    ...
    p {
      text-align: left; /* Ensures paragraphs are aligned left */
    }

    ul {
      text-align: left; /* Ensures the unordered list is left-aligned */
      padding-left: 20px; /* Adds space to the left for better readability */
    }
    ...
    /* Center-aligned text under 'My Projects' and 'Contact Us' */
    #projects p, #contact p {
      text-align: center; /* Centers text for these sections */
    }
